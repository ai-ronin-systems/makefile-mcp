...
from makefile_mcp.errors import VariableValidationError
from makefile_mcp.filesystem import ensure_within_root
from makefile_mcp.models import TaskDefinition, VariableSpec, VariableType
...
def _task_has_string_variables(task: TaskDefinition) -> bool:
    ...
    # recipes one stable contract: declaring `string` always means MAKEFILE_MCP_INPUT exists.
...
def string_input_file(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="makefile-mcp-", dir="/tmp") as temporary_directory:
